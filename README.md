...
<head>
    ...
    <style>
        .hero {
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), <img src="https://rawgithubusercontent.com/walkersedgefarm/walkersedgefarm.github.io/main/Sunset.jpg" alt="Sunset" ;
